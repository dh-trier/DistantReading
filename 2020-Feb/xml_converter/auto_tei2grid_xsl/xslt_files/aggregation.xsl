    ...
    <xsl:template match="/">
        <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
            ...
            <rdf:Description rdf:about="-DEU.aggregation">
                <ore:aggregates rdf:resource="DEU/DEU001.edition"/>  <!-- DEU, HUN, FRA/... .edition -->
                <ore:aggregates rdf:resource="DEU/DEU002.edition"/>
                <ore:aggregates rdf:resource="HUN/HUN001.edition"/>
                <ore:aggregates rdf:resource="HUN/HUN002.edition"/>
            </rdf:Description>
        </rdf:RDF>
    </xsl:template>
